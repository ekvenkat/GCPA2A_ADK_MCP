...
# IMPORTANT: This is the primary agent that ADK will look for
# We're choosing the SQL agent as our main agent, but you could use any of them
agent = sql_agent

# Optionally export all agents if you need to access them elsewhere
__all__ = ["agent", "judge_agent", "mask_agent", "sql_agent"]